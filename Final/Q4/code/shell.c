...
void displayCode(int errorCode, char * command){
    ...
    case -6:
        ...
        break;
    case -7:
        printf("ERRORCODE -7 : ERROR with partition \n");
        break;
    case -8:
        printf("ERRORCODE -8 : ERROR with mountFS \n");
        break;
    case -9:
        printf("ERRORCODE -9 : ERROR with read \n");
        break;
    case -10:
        printf("ERRORCODE -10 : ERROR with write \n");
        break;
    case -11:
        printf("ERRORCODE -11 : ERROR with openFile \n");
        break;
    }
